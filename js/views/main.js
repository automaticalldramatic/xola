 ...
 * @description This file loads data from the JSON feed. However, 
 * currently the JSON feed is not working due to CORS set on the server. 
 * You need to refer to main1.js for static data.
 * 
